...
for list_chem in l_list_chem:
    print("==>", list_chem)
    l_d_chem_bylist = run_EPA_API(x_api_key, "/chemical/list/chemicals/search/by-listname/%s"%(list_chem))
...
df_chemical.to_parquet(p_dir_bricks + "/chemicals_by_list.parquet")